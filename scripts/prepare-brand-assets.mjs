...
// Social preview 1200×630 and PWA / iOS icons.
{
  ...
  const bg = Buffer.from(`<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    <defs>
      <linearGradient id="g" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#17171A"/><stop offset="0.6" stop-color="#0E0E10"/><stop offset="1" stop-color="#060606"/></linearGradient>
      ...
      <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M40 0H0V40" fill="none" stroke="#A8A49C" stroke-opacity="0.08"/></pattern>
    </defs>
    ...
    <text x="${W / 2}" y="${H - 52}" text-anchor="middle" font-family="DejaVu Sans, Arial, sans-serif" font-size="20" fill="#A8A49C">aishweb-ezy-ai.vercel.app</text>
  </svg>`);
