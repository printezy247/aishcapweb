...
Removed 2026-09-07 on the client's request: the numbered "Notes" block above the footer and its superscript references (1.4). Every qualifier it carried already appears inline: self-reported line and dashboard source on the card, "gains only" on the proof list and fee cards, the counted date on the member figure, the consent note under the quotes.
